...
@can('real_estate_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('user.real-estates.create') }}">
                        ...
                        <tr data-entry-id="{{ $realEstate->id }}">
                            ...
                            <td>
                                @can('real_estate_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('user.real-estates.show', $realEstate->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('real_estate_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('user.real-estates.edit', $realEstate->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('real_estate_delete')
                                    <form action="{{ route('user.real-estates.destroy', $realEstate->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
