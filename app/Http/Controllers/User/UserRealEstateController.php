...
class UserRealEstateController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('user.realEstates.create', compact('locations', 'types', 'users'));
    }
    ...
    public function store(StoreRealEstateRequest $request)
    {
        ...
        return redirect()->route('user.real-estates.index');
    }
    ...
    public function edit(RealEstate $realEstate)
    {
        ...
        return view('user.realEstates.edit', compact('locations', 'realEstate', 'types', 'users'));
    }
    ...
    public function show(RealEstate $realEstate)
    {
        ...
        return view('user.realEstates.show', compact('realEstate'));
    }
